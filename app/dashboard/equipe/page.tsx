    ...
    return (
      <div>
        ...
        <PlanLockScreen
          ...
          message="Invitez vos associés avec le Plan Cabinet à 119 €/mois. Chaque membre a son propre espace de génération et ses propres réseaux sociaux. Économisez 28 €/mois par rapport à 3 abonnements Pro séparés."
          minPlan="cabinet"
        />
      </div>
    )
